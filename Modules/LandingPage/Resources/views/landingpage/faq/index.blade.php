                                        ...
                                        <div class="col switch-width text-end">
                                            <div class="form-group mb-0">
                                                <div class="form-check form-switch form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="faq_status" name="faq_status" {{ $settings['faq_status'] == 'on' ? 'checked="checked"' : '' }}>
                                                ...
                                                @foreach ($faqs as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td style="display: flex;justify-content: space-around;">
                                                            <a href="#" class="btn btn-primary" data-url="{{ route('faq_edit',$key) }}" data-ajax-popup="true" data-title="{{__('Edit FAQ')}}"  title="{{__('Edit')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
