                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::textarea('site_description', $settings['site_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description')]) }}
                                            @error('mail_port')
                                            ...
                                            @if (is_array($pages) || is_object($pages))
                                                ...
                                                @foreach ($pages as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <a href="#" class="btn btn-primary" data-url="{{ route('custom_page.edit',$key) }}" data-ajax-popup="true" data-title="{{__('Edit Page')}}" data-size="lg" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
