...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('service/{id}/detail', [ServiceController::class, 'warehouseDetail'])->name('service.detail');
    Route::post('empty-cart', [ServiceController::class, 'emptyCart'])->middleware(['auth', 'XSS']);
    Route::post('warehouse-empty-cart', [ServiceController::class, 'warehouseemptyCart'])->name('warehouse-empty-cart')->middleware(['auth', 'XSS']);
    Route::resource('service', ServiceController::class)->middleware(['auth', 'XSS', 'revalidate']);
...
//        Route::get('report/profit-loss-summary', [ReportController::class, 'profitLossSummary'])->name('report.profit.loss.summary');
    ...
    Route::resource('freelancers', FreelancerController::class)->middleware(['auth', 'XSS']);
    Route::get('freelancers/create-projects/{freelancer}', [FreelancerController::class,'createProjects'])->middleware(['auth', 'XSS'])->name('freelancers.create_projects');
    Route::post('freelancers/store-projects/{freelancer}', [FreelancerController::class,'storeProjects'])->middleware(['auth', 'XSS'])->name('freelancers.store_projects');
    Route::get('freelancers/all-projects/{freelancer}', [FreelancerController::class,'allProjects'])->middleware(['auth', 'XSS'])->name('freelancers.all_projects');
    Route::delete('freelancers/delete-projects/{project}', [FreelancerController::class,'deleteProjects'])->middleware(['auth', 'XSS'])->name('freelancers.delete_projects');


    Route::resource('suppliers', SupplierController::class)->middleware(['auth', 'XSS']);
    Route::get('suppliers/create-projects/{supplier}', [SupplierController::class,'createProjects'])->middleware(['auth', 'XSS'])->name('suppliers.create_projects');
    Route::post('suppliers/store-projects/{supplier}', [SupplierController::class,'storeProjects'])->middleware(['auth', 'XSS'])->name('suppliers.store_projects');
    Route::get('suppliers/all-projects/{supplier}', [SupplierController::class,'allProjects'])->middleware(['auth', 'XSS'])->name('suppliers.all_projects');
    Route::delete('suppliers/delete-projects/{project}', [SupplierController::class,'deleteProjects'])->middleware(['auth', 'XSS'])->name('suppliers.delete_projects');
    ...
    Route::resource('position',PositionController::class)->middleware(['auth', 'XSS']);
    Route::post('new-position',[PositionController::class,'newPostionAjax'])->middleware(['auth', 'XSS'])->name('new.positions.ajax');
    ...
    Route::delete('projects/{id}/users/{uid}', [ProjectController::class, 'destroyProject'])->name('projects.user.destroy')->middleware(['auth', 'XSS']);
    Route::delete('projects/{id}', [ProjectController::class, 'destroyProjectUser'])->name('projects.destroy')->middleware(['auth', 'XSS']);
    ...
    Route::get('projects/{id}/services', [ProjectController::class, 'services'])->name('projects.services')->middleware(['auth', 'XSS']);
    Route::get('projects/{id}/delete-services', [ProjectController::class, 'deleteServices'])->name('projects.deleteServices')->middleware(['auth', 'XSS']);
    
    Route::get('projects/{id}/positions', [ProjectController::class, 'positions'])->name('projects.positions')->middleware(['auth', 'XSS']);
    Route::get('projects/{id}/edit-positions', [ProjectController::class, 'editPositions'])->name('projects.editPositions')->middleware(['auth', 'XSS']);
    Route::post('projects/{id}/edit-position', [ProjectController::class, 'editPosition'])->name('projects.edit.positions')->middleware(['auth', 'XSS']);
    Route::get('projects/{id}/delete-positions', [ProjectController::class, 'deletePositions'])->name('projects.deletePositions')->middleware(['auth', 'XSS']);
    Route::post('projects/{id}/store-positions', [ProjectController::class, 'storePositions'])->name('projects.store.positions')->middleware(['auth', 'XSS']);

    Route::get('projects/{id}/employees', [ProjectController::class, 'employees'])->name('projects.employees')->middleware(['auth', 'XSS']);
    Route::get('projects/{id}/edit-employees', [ProjectController::class, 'editEmployees'])->name('projects.editEmployees')->middleware(['auth', 'XSS']);
    Route::post('projects/{id}/edit-employee', [ProjectController::class, 'editEmployee'])->name('projects.edit.Employees')->middleware(['auth', 'XSS']);
    Route::get('projects/{id}/delete-employees', [ProjectController::class, 'deleteEmployees'])->name('projects.deleteEmployees')->middleware(['auth', 'XSS']);
    Route::post('projects/{id}/store-employees', [ProjectController::class, 'storeEmployees'])->name('projects.store.employees')->middleware(['auth', 'XSS']);
    ...
    // End Project Module
    Route::resource('customs', CustomRequestController::class)->middleware(['auth', 'XSS']);
    Route::get('customs-view', [CustomRequestController::class, 'filterCustomView'])->name('filter.custom.view')->middleware(['auth', 'XSS']);
    Route::get('customs/{id}/positions', [CustomRequestController::class, 'positions'])->name('customs.positions')->middleware(['auth', 'XSS']);
    Route::get('customs/{id}/edit-positions', [CustomRequestController::class, 'editPositions'])->name('customs.editPositions')->middleware(['auth', 'XSS']);
    Route::post('customs/{id}/edit-position', [CustomRequestController::class, 'editPosition'])->name('customs.edit.positions')->middleware(['auth', 'XSS']);
    Route::get('customs/{id}/delete-positions', [CustomRequestController::class, 'deletePositions'])->name('customs.deletePositions')->middleware(['auth', 'XSS']);
    Route::post('customs/{id}/store-positions', [CustomRequestController::class, 'storePositions'])->name('customs.store.positions')->middleware(['auth', 'XSS']);
...
//    Route::get('{id}/plan-get-payment-status', [PaypalController::class, 'planGetPaymentStatus'])->name('plan.get.payment.status')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    Route::get('export/service', [ServiceController::class, 'export'])->name('service.export');
    Route::get('import/service/file', [ServiceController::class, 'importFile'])->name('service.file.import');
    Route::post('import/service', [ServiceController::class, 'import'])->name('service.import');
    ...
    Route::get('add-to-cart/{id}/{session}', [ServiceController::class, 'addToCart'])->middleware(['auth', 'XSS']);
    Route::patch('update-cart', [ServiceController::class, 'updateCart'])->middleware(['auth', 'XSS']);
    Route::delete('remove-from-cart', [ServiceController::class, 'removeFromCart'])->middleware(['auth', 'XSS']);
    ...
    Route::get('search-products', [ServiceController::class, 'searchProducts'])->name('search.products')->middleware(['auth', 'XSS']);
