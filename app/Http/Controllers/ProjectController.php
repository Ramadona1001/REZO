...
class ProjectController extends Controller
{
    ...
    public function index($view = 'list')
    {
        if (\Auth::user()->can('manage project')) {
            ...
            return view('projects.index', compact('view', 'positions', 'services'));
        } else {
    ...
    public function create()
    {
        if (\Auth::user()->can('create project')) {
            ...
            $projectId      = idFormat('project', $this->positionNumber());
            return view('projects.create', compact('clients', 'employees', 'services', 'projectId'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied.'));
        }
    }
    ...
    public function show(Project $project)
    {
        if (\Auth::user()->can('view project')) {
            ...
            if (\Auth::user()->type == 'client') {
                ...
                $user_projects = ProjectEmployee::whereIn('employee_id', $employees)->pluck('project_id')->toArray();
                //   $user_projects = $usr->projects->pluck('id')->toArray();
            }
            $employees_project = ProjectEmployee::where('project_id', $project->id)->get();
            $project_data = [];
            // Task Count
            ...
            return view('projects.view', compact('project', 'project_data', 'last_task','employees_project'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied.'));
        }
    }
    ...
    public function edit(Project $project)
    {
        if (\Auth::user()->can('edit project')) {
            ...
            if ($project->created_by == \Auth::user()->creatorId()) {
                return view('projects.edit', compact('project', 'clients', 'services', 'project_services', 'projectId'));
            } else {
                return response()->json(['error' => __('Permission denied.')], 401);
            }
            return view('projects.edit', compact('project', 'services', 'clients', 'project_services', 'projectId'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied.'));
        }
    }
    ...
    public function services($id)
    {
        ...
        $project_services = ProjectService::where('project_id', $project->id)->get();
        return view('projects.services', compact('project', 'project_services'));
    }
    ...
    public function positions($id)
    {
        ...
        return view('projects.positions', compact('project', 'positions', 'project_position'));
    }
    ...
    public function editPositions($id)
    {
        ...
        return view('projects.edit-positions', compact('project', 'positions', 'project_position'));
    }
    ...
    {
        $project_position = ProjectPosition::findOrfail($id);
        $project = Project::findOrfail($project_position->project_id);
    ...
    public function employees($id)
    {
        ...
        return view('projects.employees', compact('project', 'positions', 'project_position', 'employees'));
    }
    ...
    public function editEmployees($id)
    {
        ...
        return view('projects.edit-employees', compact('project', 'project_positions'));
    }
    ...
    public function loadUser(Request $request)
    {
        if ($request->ajax()) {
            ...
            $employees_project = ProjectEmployee::where('project_id',$project->id)->get();
            $returnHTML = view('projects.users', compact('project','employees_project'))->render();
    ...
    public function filterProjectView(Request $request)
    {
        ...
        if (\Auth::user()->can('manage project')) {
            $usr           = Auth::user();
            $user_projects = Project::where('created_by', \Auth::user()->creatorId())->pluck('id', 'id')->toArray();
            // if(\Auth::user()->type == 'client'){
