...
class Utility extends Model
{
    ...
    public static function settings()
    {
        ...
        $settings = [
            ...
            "position_prefix" => "#POS00",
            "client_prefix" => "#CLIENT00",
            "department_prefix" => "#DEP00",
            "section_prefix" => "#UNIT00",
            "service_prefix" => "#SER00",
            "project_prefix" => "#POJ00",
            "freelancer_prefix" => "#FREE00",
            "supplier_prefix" => "#SUP00",
            "custom_request_prefix" => "#CUSREQ00",
            'leave_status' => '1',
            "bug_prefix" => "#ISSUE",
            'title_text' => '',
            'footer_text' => '',
