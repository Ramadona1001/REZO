...
<div class="modal-body">
    <div class="row">
        <div class="form-group mb-3">
            {{ Form::label('Client ID', __('Client ID'),['class'=>'form-label']) }}
            {{ Form::text('Client ID', $clientId, array('class' => 'form-control','placeholder'=>__('Enter client Name'),'required'=>'required','readonly'=>'readonly')) }}
        </div>
        <div class="form-group mb-3">
