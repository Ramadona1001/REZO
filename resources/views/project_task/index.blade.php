                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                <ul class="list-inline mb-0">
                                                    <li class="list-inline-item d-inline-flex align-items-center"
                                                        ...
                                                        <i class="f-16 text-primary fa fa-file"></i>&nbsp;
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item d-inline-flex align-items-center"
                                                        ...
                                                        <i class="f-16 text-primary fa fa-message"></i>&nbsp;
                                                    ...
                                                    <li class="list-inline-item d-inline-flex align-items-center"
                                                        ...
                                                        <i
                                                            class="f-16 text-primary fa fa-list"></i>&nbsp;{{ $taskDetail->countTaskChecklist() }}
                                                    </li>
                                                </ul>
                                                <div class="user-group">
                                                    @foreach ($taskDetail->users() as $user)
                                                        <h5>{{ !empty($user) ? $user->name : '' }}</h5>
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>

                                        <div class="card-footer d-flex justify-content-center" style="gap: 5px">
                                            ...
                                            @can('delete project task')
                                                ...
                                                <a href="#!" class="bs-pass-para btn btn-sm btn-danger">
