            ...
            <div class="col-4">
                <div class="plan_card">
                    <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s"
                       ...
                       ">
                        <div class="card-body">
                            <span class="price-badge bg-primary p-2 text-white mb-2" style=" width: 100%; display: block; text-align: center; ">{{ $plan->name }}</span>
                                ...
                                {{-- <div class="col-6">
                                    <ul class="list-unstyled my-5">
                                        <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->max_users == -1 ? __('Unlimited') : $plan->max_users }}
                                            {{ __('Users') }}</li>
                                        <li class="text-wrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->max_customers == -1 ? __('Unlimited') : $plan->max_customers }}
                                            {{ __('Customers') }}</li>
                                        <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->max_venders == -1 ? __('Unlimited') : $plan->max_venders }}
                                            {{ __('Vendors') }}</li>
                                        <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->max_clients == -1 ? __('Unlimited') : $plan->max_clients }}
                                            {{ __('Clients') }}</li>
                                        <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->storage_limit == -1 ? __('Unlimited') : $plan->storage_limit . ' MB'}}
                                            {{ __('Storage') }}</li>
                                    </ul>
                                </div> --}}
                                {{-- <div class="col-6">
                                    <ul class="list-unstyled my-5">
                                        <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->account == 1 ? __('Enable') : __('Disable') }}
                                            {{ __('Account') }}</li>
                                        <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->crm == 1 ? __('Enable') : __('Disable') }}
                                            {{ __('CRM') }}</li>
                                        <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->hrm == 1 ? __('Enable') : __('Disable') }}
                                            {{ __('HRM') }}</li>
                                        <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->project == 1 ? __('Enable') : __('Disable') }}
                                            {{ __('Project') }}</li>
                                        <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->pos == 1 ? __('Enable') : __('Disable') }}
                                            {{ __('POS') }}</li>
                                        <li class="white-sapce-nowrap"><span class="theme-avtar"><i
                                                    class="text-primary fa fa-circle-plus"></i></span>{{ $plan->chatgpt == 1 ? __('Enable') : __('Disable') }}
                                            {{ __('Chat GPT') }}</li>
