                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            ...
                                            <span>{{!empty($employee)?$employee->city:''}}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold">{{__('Country')}} :</strong>
                                            <span>{{!empty($employee)?$employee->country:''}}</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                        ...
                        <div class="card ">
                            <div class="card-body employee-detail-body fulls-card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold">{{__('Section')}} :</strong>
                                    ...
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold">{{__('Contract End Date')}} :</strong>
                                            <span>{{\Auth::user()->dateFormat(!empty($employee)?$employee->contract_end_date:'')}}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="info text-sm">
                                            <strong class="font-bold">{{__('Contract Type')}} :</strong>
                                            <span>
