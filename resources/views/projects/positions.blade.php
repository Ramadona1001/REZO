{{ Form::model($project, ['route' => ['projects.store.positions', $project->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
    @if ($project_position < $project->positions)
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-6 col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('positions_count[]',$project->positions, ['class' => 'form-control','step'=>0.01,'min' => 0]) }}
            </div>
        </div>
    </div>
