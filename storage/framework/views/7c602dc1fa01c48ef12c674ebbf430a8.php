                                        ...
                                        <?php $__currentLoopData = $pipeline['lead_stages']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead_stages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="d-flex align-items-center justify-content-between list-group-item" data-id="<?php echo e($lead_stages->id); ?>">
                                                ...
                                                <span class="float-end">
                                                    ...
                                                    <a href="#" class="mx-3 btn btn-primary btn-sm d-inline-flex align-items-center" data-url="<?php echo e(URL::to('lead_stages/'.$lead_stages->id.'/edit')); ?>" data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Lead Stages')); ?>">
                                                    ...
                                                    <?php if(count($pipeline['lead_stages'])): ?>
                                                        ...
                                                        <a href="#" class="mx-3 btn-danger btn btn-sm  align-items-center bs-pass-para" data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>"><i class="fa fa-trash text-white"></i></a>
                                                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rezo2\resources\views/lead_stages/index.blade.php ENDPATH**/ ?>