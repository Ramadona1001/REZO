                                ...
                                <div class="col switch-width text-end">
                                    <div class="form-group mb-0">
                                        <div class="form-check form-switch form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="faq_status" name="joinus_status" <?php echo e($settings['joinus_status'] == 'on' ? 'checked="checked"' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rezo2\Modules/LandingPage\Resources/views/landingpage/joinus.blade.php ENDPATH**/ ?>