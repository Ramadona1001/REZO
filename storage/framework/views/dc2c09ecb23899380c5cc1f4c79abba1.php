                                ...
                                <tr>
                                    ...
                                    <td class="Action">
                                        <span>
                                                ...
                                                <a href="#" class="mx-3 btn btn-sm btn-danger align-items-center bs-pass-para" data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>"><i class="fa fa-trash text-white"></i></a>
                                                <?php echo Form::close(); ?>

                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit pipeline')): ?>
                                            <a href="#" class="mx-3 btn btn-primary btn-sm d-inline-flex align-items-center" data-url="<?php echo e(URL::to('pipelines/'.$pipeline->id.'/edit')); ?>" data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Pipeline')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rezo2\resources\views/pipelines/index.blade.php ENDPATH**/ ?>