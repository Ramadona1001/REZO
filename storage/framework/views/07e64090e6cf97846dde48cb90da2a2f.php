<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Custom Requests')); ?>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Custom Requests')); ?></li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
                ...
                <div class="dropdown-menu  project-filter-actions dropdown-steady" id="project_status">
                    ...
                    <?php $__currentLoopData = \App\Models\CustomRequest::$project_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="dropdown-item filter-action pl-4" href="#" data-val="<?php echo e($key); ?>"><?php echo e(__($val)); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            

        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create custom request')): ?>
            <a href="#" data-size="lg" data-url="<?php echo e(route('customs.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create New Custom Request')); ?>" data-title="<?php echo e(__('Create Custom Request')); ?>" class="btn btn-sm btn-primary">
...
<script>
    ...
    function ajaxFilterProjectView(project_sort, keyword = '', status = '') {
        ...
        currentRequest = $.ajax({
            url: '<?php echo e(route('filter.custom.view')); ?>',
            data: data,
            beforeSend: function () {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rezo2\resources\views/custom_requests/index.blade.php ENDPATH**/ ?>