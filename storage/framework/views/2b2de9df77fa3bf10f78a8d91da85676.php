                                                ...
                                                <div class="choose-files mt-5">
                                                    <label for="home_banner">
                                                        <div class=" bg-primary company_logo_update" style="cursor: pointer;">
                                                            <i class="fa fa-upload px-1"></i><?php echo e(__('Choose file here')); ?>
                                                                ...
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    <div class="col-auto">
                                                                        <p class="card-text small text-muted">
                                                                            <img src="<?php echo e($logo . '/logo-light.png'); ?>"
                                                                            alt="<?php echo e(config('app.name', 'Resource-Managment')); ?>" class="logo logo-lg">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rezo2\Modules/LandingPage\Resources/views/landingpage/homesection.blade.php ENDPATH**/ ?>