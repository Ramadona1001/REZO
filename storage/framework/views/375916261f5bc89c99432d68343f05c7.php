                                        ...
                                        <tr class="font-style">
                                            ...
                                            <td class="Action d-flex gap-3">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit role')): ?>
                                                    <?php if($role->name != 'employee' && $role->name != 'super admin'): ?>
                                                        <a href="#"
                                                            class="btn btn-primary d-inline-flex align-items-center"
                                                            data-url="<?php echo e(route('roles.edit', $role->id)); ?>"
                                                            data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip"
                                                            title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Role Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rezo2\resources\views/role/index.blade.php ENDPATH**/ ?>