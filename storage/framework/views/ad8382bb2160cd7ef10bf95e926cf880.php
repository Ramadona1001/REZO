...
<?php $__env->startSection('content'); ?>
    <div class="card-body">
        ...
        <?php if($get_plan != null): ?>
            <div style=" background: #0665d0; color: white; padding: 10px; border-radius: 5px; ">
                <div><?php echo e(__('Plan Name').' : '.$get_plan->name); ?></div>
                <div><?php echo e(__('Price').' : '); ?><?php echo e(isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$'); ?><?php echo e(intval($get_plan->price)); ?></div>
            </div>
            <hr>
        <?php endif; ?>
        <form method="POST" action="<?php echo e(route('register')); ?>">
            <?php if($get_plan != null): ?>
            <input type="hidden" name="plan_id" value="<?php echo e($get_plan->id); ?>">
            <?php else: ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rezo2\resources\views/auth/register.blade.php ENDPATH**/ ?>